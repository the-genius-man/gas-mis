...
console.log('🔄 Creating database reset instructions...');
...
fs.writeFileSync(path.join(__dirname, 'database-reset-instructions.txt'), instructions);
console.log('\n📄 Instructions saved to: scripts/database-reset-instructions.txt');
console.log('\n💡 Please follow the instructions above to reset your database.');